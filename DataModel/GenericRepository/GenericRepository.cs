...
namespace DataModel.GenericRepository
{
    ...
    public class GenericRepository <TEntity,context> :IGenericRepository<TEntity> where TEntity : class
        where context: InvestmentTrackerEntities
    {
        ...
        /// <param name="predicate">Criteria to match on</param>
        /// <returns>A single record containing the first record matching the specified criteria</returns>
        public TEntity FindRecord(Func<TEntity, bool> predicate)
        {
